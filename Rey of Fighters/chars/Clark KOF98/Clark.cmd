...
[Command]
name = "弱ウルトラアルゼンチンバックブリーカー"
command = ~F, DF, D, DB, B, F, DF, D, DB, B, x
time = 35

[Command]
name = "強ウルトラアルゼンチンバックブリーカー"
...
[Command]
name = "弱スーパーアルゼンチンバックブリーカー"
command = ~B, DB, D, DF, F, a
time = 20

[Command]
name = "強スーパーアルゼンチンバックブリーカー"
...
[State -1, スーパーアラビアンバーグラリーバックブリーカー]
type = ChangeState
value = 1200
triggerall = var(59) != 1
triggerall =!Ishelper
...
trigger3  = stateno = 800 || stateno = 805 || stateno = 1500 || stateno = 3000 || stateno = 3050
trigger4  = var(52) = 3
...
[State -1, 攻撃避け]
type = ChangeState
value = 720;ifelse(P2bodydist X >= 120 && Random%3 = 0,36,720)
triggerall = var(59) = 1
triggerall = var(57) >= 1
triggerall = var(9) = 1
triggerall = RoundState = 2 && enemynear(var(58)),life > 0 && Helper(40000),fvar(1) = 0
...
trigger2 = enemynear(var(58)),statetype = A
trigger2 = p2bodydist y = [-80-floor(6*(enemynear(var(58)),vel y)+(6*(6+1)/2)*fvar(29)),0-floor(6*(enemynear(var(58)),vel y)+(6*(6+1)/2)*fvar(29))]
...
trigger1 = p2bodydist y = [-60-floor(8*(enemynear(var(58)),vel y)+(8*(8+1)/2)*fvar(29)),0-floor(8*(enemynear(var(58)),vel y)+(8*(8+1)/2)*fvar(29))]
...
triggerall = Random <= var(57) * 125
triggerall = var(57) < 6 && movecontact = 1 && Random <= 100 || var(57) >= 6
triggerall = (var(40) = 0 && Random <= 250 || var(40) > 0 && Random <= 600) || var(57) >= 6 && p2life <= 502
triggerall = statetype != A
triggerall = enemynear(var(58)),statetype != A
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),movetype = H
...
trigger6 = stateno = 300 && (movecontact = 1 || movereversed = 1)
...
triggerall = RoundState = 2 && enemynear(var(58)),life > 0 && Helper(40000),fvar(1) = 0
triggerall = Random <= var(57) * 125
triggerall = Random <= 100 || var(57) >= 6 && p2life <= 372
triggerall = var(57) < 6 && movecontact = 1 && Random <= 100 || var(57) >= 6
triggerall = statetype != A
triggerall = enemynear(var(58)),statetype != A
triggerall = enemynear(var(58)),statetype != L
...
triggerall = enemynear(var(58)),movetype = H
triggerall = enemynear(var(58)),stateno != [5710,5715]
trigger1 = stateno = 1112 && AnimElemTime(3) >= 2 && AnimElemTime(8) < 0
trigger2 = stateno = 1210 && AnimElemTime(12) >= 4
trigger3 = stateno = 1311 && AnimElemTime(2) >= 5 && AnimElemTime(4) < 0
trigger4 = 0;stateno = 1420 && AnimElemTime(8) >= 2 && AnimElemTime(9) < 0
trigger5 = stateno = 1512 && AnimElemTime(3) >= 3 && AnimElemTime(6) < 0
...
trigger1 = stateno != 55 && Vel Y >= 0 && Pos Y >= -50-floor(4*vel Y) || stateno = 55 && Time >= 19
...
triggerall = enemynear(var(58)),facing != facing
triggerall = ctrl || (stateno = [20,22]) || (stateno = [30,40]) || (stateno = [100,101]) || (stateno = [120,149]) || (var(1) = [1,2]) || var(2) >= 1
trigger1 = (p2bodydist x = [ifelse(backedgebodydist<=10,-28,-8+floor(11*(enemynear(var(58)),vel x))),43+floor(11*(enemynear(var(58)),vel x))]) || (p2bodydist x = [-8,0]) && p2bodydist y > -64
trigger1 = p2bodydist y = [0-floor(10.5*(enemynear(var(58)),vel y)+(10.5*(10.5+1)/2)*fvar(29)),20-floor(10.5*(enemynear(var(58)),vel y)+(10.5*(10.5+1)/2)*fvar(29))]
...
triggerall = p2bodydist X > 37
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149]) || var(2) >= 1
trigger1 = p2bodydist x = [0+floor(9*(enemynear(var(58)),vel x)),85+floor(9*(enemynear(var(58)),vel x))]
trigger1 = p2bodydist y = [-70-floor(9*(enemynear(var(58)),vel y)+(9*(9+1)/2)*fvar(29)),0-floor(9*(enemynear(var(58)),vel y)+(9*(9+1)/2)*fvar(29))]
...
trigger1 = p2bodydist y = [-75-floor(5*(enemynear(var(58)),vel y)+(5*(5+1)/2)*fvar(29)),0-floor(5*(enemynear(var(58)),vel y)+(5*(5+1)/2)*fvar(29))]
...
triggerall =!InGuardDist
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149]) || var(2) >= 1
trigger1 = p2bodydist x = [-10+floor(10*(enemynear(var(58)),vel x)),50+floor(10*(enemynear(var(58)),vel x))]
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),stateno != [5020,5040]
triggerall = p2bodydist x = [-20,45+floor(4*(EnemyNear(Var(58)),vel X)+floor(4*vel X))]
triggerall = ctrl || stateno = 55 || (stateno = [120,149])
...
trigger1 = p2bodydist x = [-20,50+floor(5*(EnemyNear(var(58)),vel X)+floor(5*vel X))]
trigger1 = enemynear(var(58)),Pos Y - Pos Y = [-80,10]
...
triggerall = enemynear(var(58)),statetype != L
triggerall = enemynear(var(58)),stateno != [5020,5040]
triggerall = p2bodydist x = [-20+floor(14*(EnemyNear(Var(58)),vel X)+floor(14*vel X)),56+floor(14*(EnemyNear(Var(58)),vel X)+floor(14*vel X))]
triggerall = ctrl || stateno = 55 || (stateno = [120,149])
