...
triggerall = RoundState = 2
triggerall = !var(40)
trigger1  = Movecontact && (StateNo = [200,205]) || StateNo = 215 || StateNo = 235
...
trigger2 = var(30)=1 && fvar(0) > 0 && ((100*life/const(data.life))<=2500 || var(44) = 2)
trigger3 = var(30)=2 && ((!var(49) && (100*life/const(data.life))<=5000) || var(44) = 2)
triggerall = StateType !=  C && (Ctrl || (var(40)=[1,3])|| stateno = 3001 || stateno = 3210 || stateno = 1302 || stateno = 1312 || stateno = 1500 || stateno = 1510 || stateno = 1601 || stateno = 1611 || stateno = 1400 || stateno = 1410)
;---------------------------------------------------------------------
[State -1]
type = ChangeState
value = 3320
triggerall = command = "mio"
triggerall = power >= ifelse(Var(23)>0,1000,2000)
trigger1 = var(30)=0 && var(47)=0
trigger2 = var(30)=2 && ((!var(49) && (100*life/const(data.life))<=5000) || var(44) = 2)
triggerall = StateType !=  C && (Ctrl || (var(40)=[1,3])|| stateno = 3001 || stateno = 3210 || stateno = 1302 || stateno = 1312 || stateno = 1500 || stateno = 1510 || stateno = 1601 || stateno = 1611 || stateno = 1400 || stateno = 1410)
...
triggerall = power >= ifelse(Var(23)>0,1000,2000)
trigger1 = var(30)=0 && var(47)=0
triggerall = StateType != A && (Ctrl || (var(40)=[1,3])|| stateno = 1510)
...
trigger7 = movecontact && stateno = 1510 && time = [8,11]
...
trigger4 = stateno = 1601 && movecontact
trigger5 = stateno = 1611 && movecontact
trigger6 = stateno = 1302
trigger7 = stateno = 1312
...
trigger6 = stateno = 1350 && movecontact = 1
trigger7 = stateno = 1360 && movecontact = 1
trigger8 = movecontact && stateno = 1510 && time = [9,15]
trigger9 = movecontact && stateno = 700 && time = [19,22]
...
triggerall = StateType != A && (Ctrl || (var(40)=[1,3]) || stateno = 3210)
;---------------------------------------------------------------------
; ガードキャンセル吹っ飛ばし攻撃
[State -1]
type = ChangeState
