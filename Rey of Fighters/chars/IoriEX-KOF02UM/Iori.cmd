...
trigger3  = stateno = 800 || stateno = 805 || stateno = 1300
trigger4  = var(52) = 3
...
trigger1 = enemynear(var(58)),statetype = S && (p2bodydist X = [-5,40]) || enemynear(var(58)),statetype != S && (p2bodydist X = [-5,80])
...
trigger1 = Target,Life <= 211
trigger2 = power >= 2000 && var(40) = 0
trigger2 = Target,Life <= 347
trigger3 = power >= 2000 && var(40) = 0
trigger3 = ((1000*Life/LifeMax) <= 300 && var(38) = 0)
...
triggerall = enemynear(var(58)),stateno != [5710,5715]
trigger1 = ctrl || stateno = 0 || (stateno = [20,22]) || (stateno = [99,101]) || (stateno = [120,149]) || var(2) >= 1
trigger2 = stateno = 1110 && AnimTime = 0
...
triggerall = enemynear(var(58)),movetype = H
triggerall = movehit = 1
trigger1 = stateno = 1100 || stateno = 1205
...
triggerall = enemynear(var(58)),movetype = H
triggerall = movehit = 1
trigger1 = (stateno = 1100 || stateno = 1110) && AnimElemTime(5) > 0 && AnimElemTime(6) < 0
...
trigger1 = stateno = 235 && AnimElemTime(3) > 0 && AnimElemTime(4) < 0
...
triggerall = enemynear(var(58)),facing != facing
triggerall = ctrl || (stateno = [20,22]) || (stateno = [30,40]) || (stateno = [100,101]) || stateno = 752 || (stateno = [120,149]) || (var(1) = [1,2]) || var(2) >= 1
trigger1 = p2bodydist x = [ifelse((backedgebodydist <= 8 || enemynear(var(58)),Vel Y >= 0 && enemynear(var(58)),Pos Y >= -60),-20,0+floor(14*(enemynear(var(58)),vel x))),80+floor(14*(enemynear(var(58)),vel x))]
trigger1 = p2bodydist y = [-72-floor(14*(enemynear(var(58)),vel y)+(14*(14+1)/2)*fvar(39)),0-floor(14*(enemynear(var(58)),vel y)+(14*(14+1)/2)*fvar(39))]
...
triggerall = enemynear(var(58)),facing != facing
triggerall = ctrl || (stateno = [20,22]) || (stateno = [30,40]) || (stateno = [100,101]) || stateno = 752 || (stateno = [120,149]) || (var(1) = [1,2]) || var(2) >= 1
trigger1 = p2bodydist x = [ifelse((backedgebodydist <= 8 || enemynear(var(58)),Vel Y >= 0 && enemynear(var(58)),Pos Y >= -60),-20,0+floor(4*(enemynear(var(58)),vel x))),80+floor(4*(enemynear(var(58)),vel x))]
trigger1 = p2bodydist y = [-64-floor(4*(enemynear(var(58)),vel y)+(4*(4+1)/2)*fvar(39)),0-floor(4*(enemynear(var(58)),vel y)+(4*(4+1)/2)*fvar(39))]
...
triggerall = p2bodydist X <= 32
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149]) || var(2) >= 1
trigger1 = p2bodydist x = [ifelse((backedgebodydist <= 8 || enemynear(var(58)),Vel Y >= 0 && enemynear(var(58)),Pos Y >= -60),-20,0+floor(6*(enemynear(var(58)),vel x))),27+floor(6*(enemynear(var(58)),vel x))]
...
triggerall =!InGuardDist
triggerall = ctrl || (stateno = [20,22]) || (stateno = [100,101]) || (stateno = [120,149]) || var(2) >= 1
trigger1 = p2bodydist x = [ifelse((backedgebodydist <= 8 || enemynear(var(58)),Vel Y >= 0 && enemynear(var(58)),Pos Y >= -60),-20,0+floor(8*(enemynear(var(58)),vel x))),43+floor(8*(enemynear(var(58)),vel x))]
